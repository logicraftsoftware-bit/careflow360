      ...
      {(
        <>
          ...
          <section className="call-overview-grid">
            ...
            <article className="analytics-card answer-gauge"><div className="analytics-title"><h3>Answered vs Missed Calls</h3><p>Overall performance</p></div><div className="gauge"><svg viewBox="0 0 200 110" role="img" aria-label={`${a.answerRate || 0}% answered, ${100 - (a.answerRate || 0)}% missed`}><path className="gauge-missed" pathLength="100" d="M 20 95 A 80 80 0 0 1 180 95" /><path className="gauge-answered" pathLength="100" strokeDasharray={`${Math.min(100, a.answerRate || 0)} 100`} d="M 20 95 A 80 80 0 0 1 180 95" /></svg><div><b>{a.answerRate || 0}%</b><small>Answer Rate</small></div></div><div className="gauge-numbers"><span><i className="green" /><b>{a.answered || 0}</b><small>Answered</small></span><span><i className="red" /><b>{a.missed || 0}</b><small>Missed</small></span></div></article>
