...
export function AiSensyIntegrationsPage(){
  ...
  const {data:tenants=[],isLoading}=useQuery({queryKey:["admin-aisensy-integrations"],queryFn:()=>api.get("/super-admin/aisensy-integrations").then(unwrap)});
