...
export const sendPaymentPendingMessage=(a:AppointmentMessage)=>sendCampaign(s=>s.campaignPaymentPending,a,[a.patientName,a.clinicName,a.doctorName,a.departmentName,indiaDate(a.startsAt),indiaTime(a.startsAt),String(a.amount),paymentLinkFor(a.appointmentNumber)]);
